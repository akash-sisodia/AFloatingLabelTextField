//
//  AFloatingLabelTextField.swift
//  AFloatingLabelTextField
//
//  Created by Akash Singh Sisodia 20/05/15.
//  Copyright © 2015 Akash Singh Sisodia. All rights reserved.
//

import UIKit

@IBDesignable
@objc open class AFloatingLabelTextField: UITextField {
    ...
    @IBInspectable open var selectedLineColor : UIColor = UIColor.lightGray{
        didSet{
            self.floatTheLabel()
        }
    }
...
fileprivate extension AFloatingLabelTextField {
